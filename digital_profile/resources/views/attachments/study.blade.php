        ...
        <div class="row mb-3">
            <div class="col-md-2 themed-grid-col">
                <div class="container">
                    ...
                    <a href="/id?n={{$file->stud_id}}" class="btn btn-outline-success">
            ...
            <div class="col-md-7 themed-grid-col">
                <table class="table">
                    ...
                    @foreach($files as $file)
                        <tr>
                            <th scope="row"><a href="{{$file->url}}" class="list-group-item-action">{{$file->name}}</a></th>
            ...
            <div class="col-md-3 themed-grid-col">
                <div class="card" style="width: 18rem;">
                    ...
                    <a href="{{route("attachments.marks", ['id'=>$file->stud_id])}}" class="btn btn-outline-success btn-lg">Успеваемость</a>

                    <div class="card-body">

                        <h5 class="card-title">Портфолио</h5>
                        <ul class="list-group list-group-flush">
                            <a href="{{route("attachments.study", ['id'=>$file->stud_id])}}" class="list-group-item d-flex justify-content-between align-items-center" >
                                Учёба
